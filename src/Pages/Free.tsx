...
<a href="#" className="flex  flex-col items-center h-[60vh] m-auto w-[80vw]  bg-blue-600 border border-black border-5px rounded-3xl shadow md:flex-row ">
...
<a href="#" className="inline-flex m-auto items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 w-[60%]">
    Book Now
