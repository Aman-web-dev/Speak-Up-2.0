...
<a href="#" className="inline-flex m-auto items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-green-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 xl:w-[60%] sm:w-[auto]">
    Book Now
