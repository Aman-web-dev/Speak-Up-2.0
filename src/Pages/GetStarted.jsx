...
function GetStarted() {
  return (
    <div className='w-[80vw] m-auto text-black'>
      <div class="p-10">
    <h1 class="mb-4 font-extrabold text-4xl text-blue-500">Get Started With Speak-Up</h1>
    <p className='text-xl mb-4'> By Filling This Form You are Agreeing On the terms and Conditions Of Speak-up We are a LMS based Teaching Platform that Helps Students Learn More Than one Language for A better Industry Exposure.</p>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <form>
            ...
            <div class="flex items-center justify-between mt-8">
                <button type="submit" class="flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10">Get Started With Us</button>
