          ...
          <div className="g-0 lg:flex lg:flex-wrap">
            ...
            <div
              ...
              <div className="px-4 py-6 text-white md:mx-6 md:p-12">
                ...
                <p className="text-sm">
                Speak-up is dedicated to providing a superior learning experience. Our LMS prioritizes effective, accelerated language learning, ensuring students achieve proficiency faster and more effectively.
                </p>
              </div>
            </div>
          </div>
