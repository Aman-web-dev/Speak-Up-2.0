    ...
    <div className="grid items-center lg:grid-cols-2">
      <div className="mb-12 lg:mb-0">
        <div
          ...
          <h2 className="mb-6 text-4xl font-bold text-black">Why To Learn With Us?</h2>
          ...
          <div className="grid gap-x-6 md:grid-cols-3">
            <div className="mb-12 md:mb-0">
              <h2 className="text-dark mb-4 text-3xl font-bold text-black">10000+</h2>
            ...
            <div className="mb-12 md:mb-0">
              <h2 className="text-dark mb-4 text-3xl font-bold text-black">700+</h2>
              <h5 className="mb-0 text-lg font-medium text-neutral-500 dark:text-neutral-300">
                Teachers
              </h5>
            </div>
            ...
            <div className="">
              <h2 className="text-dark mb-4 text-3xl font-bold text-black">100+</h2>
              <h5 className="mb-0 text-lg font-medium text-neutral-500 dark:text-neutral-300">
                Languages
              </h5>
            </div>
