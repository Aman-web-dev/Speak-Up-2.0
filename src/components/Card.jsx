...
function Card(props) {
  return (
    <div className="max-w-full mx-auto my-2 p-2 border border-gray-200 rounded-lg shadow  xl:transform xl:hover:-translate-y-2 xl:transition-transform  m-auto">
      ...
      <div className="p-3">
        <a href="#">
          <h5 className="text-lg font-semibold text-gray-900 dark:text-white">{props.course}</h5>
        </a>
        ...
        <div className="flex items-center justify-between">
          <span className="text-lg font-bold text-gray-900 dark:text-white">₹: {props.price}</span>
          <a href="#" className="px-4 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-2 focus:ring-blue-300 focus:outline-none dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
        </div>
      </div>
    </div>
  );
