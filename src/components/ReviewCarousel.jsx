      ...
      <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
        ...
        <div className="hidden lg:mt-8 lg:flex lg:gap-4">
          <button
            ...
            className="sm:bg-transparent text-white bg-pink-600 rounded-full sm:border sm:border-pink-600 p-3 sm:text-pink-600 transition hover:bg-pink-600 hover:text-white"
          >
            <svg
          ...
          <button
            ...
            className="rounded-full text-white bg-pink-600 sm:border sm:border-pink-600 p-3 sm:text-pink-600 transition sm:hover:bg-pink-600 hover:text-white"
          >
            <svg
              className="h-5 w-5 rtl:rotate-180"
              fill="none"
