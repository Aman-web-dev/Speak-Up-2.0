...
function UpdatesCard() {
    return (
            ...
            <div class="flex flex-col m-auto my-2 bg-white border shadow-sm rounded-xl p-4 md:p-5 dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                <h3 class="text-lg font-bold text-gray-800 dark:text-white">
                   New French Classes From 20th July
                </h3>
